...
class Config(object):
    ...
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'usefull_botz').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002652028144"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1002652028144"))
